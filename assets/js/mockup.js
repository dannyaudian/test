(function(){
  ...
  applyDewiProc();
  syncRoleChrome();
  window.addEventListener('fast-session', function(){ applyLive(); applyExcAlamat(); applyBooking(); applySpkDraft(); applyDelivery(); applyGi(); applyAfi(); applyDewiProc(); applyHandoverCust(); });
